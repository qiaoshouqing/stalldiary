...
![StallDiary dreamy stall illustration](public/images/hero-dream-stall.png)
...
Maintainer production domain: `https://stalldiary.pomodiary.com`.
...
For this deployment, replace `https://your-stalldiary.example.com` with `https://stalldiary.pomodiary.com`.
